...
function getTutorialSteps(nick, e1, e2) {
  ...
  },
  {
    ...
    text: "Если в руке 5 карт — тебе предложат новую. Выбери одну из старых чтобы сбросить и взять новую. Или откажись — иногда лучше не брать неподходящую карту.",
    arrowDir: null,
  },
  {
    target: null,

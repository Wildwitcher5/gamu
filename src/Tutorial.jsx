...
function getTutorialSteps(nick) {
  ...
  return [
  {
    ...
    text: `Ты и твой напарник ${n} сражаетесь против Стража и Тени. У каждого 100 HP. Победа — уничтожить обоих врагов. Поражение — только если погибнете оба.`,
    arrowDir: null,
  },
  {
    target: '[data-tutorial="enemies"]',
    title: "Твои враги",
    text: "Страж и Тень действуют самостоятельно. Те же карты, та же колода — но они играют против вас. Под каждым именем видна полоска HP и сколько карт у него в руке.",
    arrowDir: "up",
  },
  {
    target: '[data-tutorial="ally"]',
    title: `Твой напарник — ${n}`,
    text: `${n} тянет карты из одной общей колоды вместе с тобой. Следи за его HP — если вы оба упадёте до 0, бой проигран. ${n} действует каждый ход и пишет тебе в чат.`,
    arrowDir: "down",
  },
  {
  ...
  },
  {
    target: null,
    title: "Вперёд",
    text: `Это всё что нужно знать. Следи за HP ${n}, используй комбо, не давай врагам накапливать урон. Чат открыт — пиши ${n} если нужна помощь.`,
    arrowDir: null,
    isLast: true,
  },
];}
